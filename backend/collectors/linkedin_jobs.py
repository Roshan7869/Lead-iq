...
Uses ScraplingAdapter with stealth mode to fetch LinkedIn job search pages,
...
from backend.collectors.scrapling_adapter import ScraplingAdapter, FetchMode
...
class LinkedInJobsCollector(BaseCollector):
    """LinkedIn Jobs collector using ScraplingAdapter + BeautifulSoup parsing."""
