...
~30,000 jobs/day. Uses ScraplingAdapter for anti-detection fetching
...
from backend.collectors.scrapling_adapter import ScraplingAdapter
from backend.services.crawler_reliability import retry_decorator
...
class ShineCollector(BaseCollector):
    """Shine.com job collector using ScraplingAdapter + HTML parsing."""
    ...
    def __init__(
        ...
        self._adapter = ScraplingAdapter(source=self.source)
    ...
    @retry_decorator(max_attempts=2, min_wait=2, max_wait=10)
